    ...
    return (
        <>
            ...
            <style>{`
                ...
                @media (max-width: 768px) { .page-bg { background-attachment: scroll; } }
            ...
            <div
                className="page-bg w-full min-h-screen overflow-x-hidden pt-20 text-[#3B3024] font-serif"
                style={{
            ...
            >
                    ...
                    <section ref={aboutRef as unknown as React.RefObject<HTMLElement>} className="contents">
                        <div className="w-full text-center text-[#063942] md:w-1/2 heebo-p1">
                            <div className="leading-tight">
                                ...
                                <h3 className="mt-1 text-3xl font-bold text-[#063942]">יועץ פיננסי מוסמך</h3>
                            </div>
                        ...
                        <div className="w-full md:w-1/2">
                            <motion.div
                                style={{ y: aboutParallax.y, opacity: aboutParallax.opacity, willChange: "transform" }}
                ...
                <Reveal id="articles" className="container px-5 py-20 mx-auto text-center" dir="rtl">
                    <section ref={articlesRef as unknown as React.RefObject<HTMLElement>} className="contents">
                        ...
                        <div className="flex justify-center mt-12 heebo-p1">
                            <motion.div
                ...
                <Reveal id="documents-upload" className="container px-5 py-20 mx-auto text-center heebo-p1" dir="rtl">
                    ...
                    <div className="justify-center hidden gap-4 mb-8 md:flex">
                        <motion.button
                            ...
                            className={`px-8 py-3 rounded-full text-lg font-semibold transition-all duration-300 ${selectedPathway === "single"
                                    ? "bg-[#97BE5A] text-white shadow-lg"
                                    : "bg-gray-200 text-[#3B3024] hover:bg-gray-300"
                                }`}
                        >
                        ...
                        <motion.button
                            ...
                            className={`px-8 py-3 rounded-full text-lg font-semibold transition-all duration-300 ${selectedPathway === "couple"
                                    ? "bg-[#97BE5A] text-white shadow-lg"
                                    : "bg-gray-200 text-[#3B3024] hover:bg-gray-300"
                                }`}
                        >
                        ...
                        <motion.button
                            ...
                            className={`px-8 py-3 rounded-full text-lg font-semibold transition-all duration-300 ${selectedPathway === "business"
                                    ? "bg-[#97BE5A] text-white shadow-lg"
                                    : "bg-gray-200 text-[#3B3024] hover:bg-gray-300"
                                }`}
                        >
