...
const HomePage = () => {
  return (
    <>
      ...
      <div className="page-bg min-h-screen w-full overflow-x-hidden pt-20 font-serif text-[#3B3024]" dir="rtl">
        <FixedSocialButtons />

        <Reveal id="logo" className="flex h-[100vh] items-center justify-center py-2 md:py-0">
          <HeroSection />
        </Reveal>
